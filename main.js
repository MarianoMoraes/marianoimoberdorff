const translations = {
  en: {
    "nav.services":"Services","nav.work":"Work","nav.about":"About","nav.cta":"Book a call",
    "hero.eyebrow":"BI & Automation Consultant · Miami · LATAM",
    "hero.h1":"Your business runs","hero.h2":"on manual work","hero.h3":"that ","hero.h4":"should run itself.",
    ...
    "hero.cta":"Book a free 30-min call","hero.cta2":"See my work",
    ...
    "about.stack":"Stack",
    "stat1":"Years corporate BI experience","stat2":"Projects delivered","stat3":"Industries served","stat4":"Languages",
    "contact.eyebrow":"Ready to start?","contact.title":"Ready to see your<br>business clearly?",
    ...
    "contact.cta":"Schedule a call →","contact.d1":"Miami, FL · LATAM","contact.d2":"English & Spanish","contact.d3":"Response within 24h"
  },
  es: {
    "nav.services":"Servicios","nav.work":"Proyectos","nav.about":"Sobre mí","nav.cta":"Agendar llamada",
    "hero.eyebrow":"Consultor BI & Automatización · Miami · LATAM",
    "hero.h1":"Tu negocio funciona","hero.h2":"con trabajo manual","hero.h3":"que ","hero.h4":"debería funcionar solo.",
    ...
    "hero.cta":"Agendá una llamada gratuita de 30 min","hero.cta2":"Ver proyectos",
    ...
    "contact.cta":"Agendar llamada →","contact.d1":"Miami, FL · LATAM","contact.d2":"Inglés & Español","contact.d3":"Respuesta en menos de 24h"
  }
};
